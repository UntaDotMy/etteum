...
export const MODEL_PRICING: Record<string, ModelPricing> = {
  ...
  // ── OpenAI — developers.openai.com/api/docs/pricing (verified 2026-08-09;
  //    includes the July 30, 2026 price cut for Terra/Luna + legacy rows) ──
  ...
  "gpt-5.6-terra":                { input: 2.00,  output: 12.00, cached: 0.20,  reasoning: 12.00,  cacheCreation: 2.50  },
  "gpt-5.6-luna":                 { input: 0.20,  output: 1.20,  cached: 0.02,  reasoning: 1.20,   cacheCreation: 0.25  },
  ...
  "gpt-5.2":                      { input: 1.75,  output: 14.00, cached: 0.175, reasoning: 14.00,  cacheCreation: 2.1875 },
  "gpt-5.2-codex":                { input: 1.75,  output: 14.00, cached: 0.175, reasoning: 14.00,  cacheCreation: 2.1875 },
  "gpt-5.1":                      { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cacheCreation: 1.5625 },
  ...
  "gpt-5":                        { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cacheCreation: 1.5625 },
  "gpt-5-mini":                   { input: 0.25,  output: 2.00,  cached: 0.025, reasoning: 2.00,   cacheCreation: 0.3125 },
  "gpt-5-nano":                   { input: 0.05,  output: 0.40,  cached: 0.005, reasoning: 0.40,   cacheCreation: 0.0625 },
  "gpt-5-pro":                    { input: 15.00, output: 120.00, cached: 1.50, reasoning: 120.00, cacheCreation: 18.75 },
  "gpt-5.2-pro":                  { input: 21.00, output: 168.00, cached: 2.10, reasoning: 168.00, cacheCreation: 26.25 },
