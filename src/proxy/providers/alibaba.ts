...
const MODELS_URL = `${DASHSCOPE_BASE}/compatible-mode/v1/models`;
const QUOTAS_URL = `${DASHSCOPE_BASE}/api/v1/quotas`;
 ...
 */
const ALI_MODEL_MAP: Record<string, {
  upstream: string;
 ...
 */
type QuotaLimitEntry = { limit: number; periodDays: number };
const quotaLimitCache = new Map<string, QuotaLimitEntry>();
